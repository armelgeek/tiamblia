...
const SortWater = require("./entities/terrain/Water");
const SortCloud = require("./entities/Cloud");
const SortDeer = require("./entities/Deer");
const SortPlayer = require("./entities/Player.ts");
